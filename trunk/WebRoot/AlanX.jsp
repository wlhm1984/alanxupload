...
//设置传入flash中的参数
var flashvars = {};  
flashvars.uploadUrl="http://10.86.14.78:8080/alanxupload/UploadServlet";//上传的url;
flashvars.extensionName="*.*";//允许扩展名，如".xls;.doc";
flashvars.extensionDisp="AlanX文件示例";//显示在扩展名前;
flashvars.maxFileN=1000;//允许上传的最大文件个数;
flashvars.maxFileSize=104857600;//允许上传的最大文件大小(byte);(10M)
flashvars.maxAllFileSize=1048576000;//允许上传的总文件最大值(byte);(100M)
